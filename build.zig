...
pub fn build(b: *std.Build) void {
    ...
    const umboard_mod = b.addModule("umboard", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "umboard" is the name you will use in your source code to
                // import this module (e.g. `@import("umboard")`). The name is
                // repeated because you are allowed to rename your imports, which
                // can be extremely useful in case of collisions (which can happen
                // importing modules from different packages).
                .{ .name = "umboard", .module = umboard_mod },
            },
        }),
    });
    exe.linkLibC();
    ...
    const create_user = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            .root_source_file = b.path("cmd/umboard-cmd_create-user.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
    ...
    umboard_mod.addImport("zap", zap.module("zap"));
    umboard_mod.addImport("umboard", umboard_mod);
    exe.root_module.addImport("zap", zap.module("zap"));

    create_user.linkLibC();
    create_user.linkSystemLibrary("sqlite3");
    create_user.root_module.addImport("clap", clap.module("clap"));
    create_user.root_module.addImport("umboard", umboard_mod);

    const cmd_datalake_clone = b.addExecutable(.{
        .name = "umboard-cmd_datalake-clone",
        .root_module = b.createModule(.{
            .root_source_file = b.path("cmd/umboard-cmd_datalake-clone.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
    ...
    const cmd_datalake_init = b.addExecutable(.{
        .name = "umboard-cmd_datalake-init",
        .root_module = b.createModule(.{
            .root_source_file = b.path("cmd/umboard-cmd_datalake-init.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
